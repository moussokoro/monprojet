...
if (isset($_POST['submit'])) {
  ...
  $ins_expediteur=$connect->prepare("INSERT INTO `traitement` (`id_trai`, `nom_maladie`, `date_debut_trait`, `date_fin_trait`, `frais_trait`, `etat_patient`, `malade_id_malade`, `medicament_prescrit`) VALUES (NULL, :maladie, :date_debut, :date_fin, :frais, :etat, :patient, :medicament)");
  $ins_expediteur->bindParam(':maladie' ,$nom_maladie , PDO::PARAM_STR);
  $ins_expediteur->bindParam(':date_debut' ,$date_debut, PDO::PARAM_STR);
  $ins_expediteur->bindParam(':date_fin' ,$date_fin, PDO::PARAM_STR);
  $ins_expediteur->bindParam(':frais' ,$frais , PDO::PARAM_STR);
  $ins_expediteur->bindParam(':etat' ,$etat_patient , PDO::PARAM_STR);
  $ins_expediteur->bindParam(':patient' ,$malade , PDO::PARAM_STR);
  $ins_expediteur->bindParam(':medicament' ,$medicament_prescrit , PDO::PARAM_STR);
    ...
    <div class="row col-md-10 col-md-offset-1">
      ...
      <form id="formID" action="" method="post">
              ...
              <div class="input-group">
               ...
               <label class="">Montant a deposer : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <input name="Montant" type="text" placeholder="" class="form-control validate[required]" />
              </div><br>
              <label class="">frais depot: <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">
                <input name="frais" type="frais" placeholder="" class="form-control validate[required]" />
